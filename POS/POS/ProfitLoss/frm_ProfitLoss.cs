...
namespace POS.ProfitLoss
{
    public partial class frm_ProfitLoss : Form
    {
        ...
        {
            dgvProfitLoss.ColumnHeadersDefaultCellStyle.Font = new System.Drawing.Font("Microsoft Sans Serif", 16F, System.Drawing.FontStyle.Bold);
            ...
            dgvProfitLoss.Columns[1].Width = (dgvProfitLoss.Width / 100) * 25;
            dgvProfitLoss.Columns[2].Width = (dgvProfitLoss.Width / 100) * 10;
            dgvProfitLoss.Columns[3].Width = (dgvProfitLoss.Width / 100) * 15;
